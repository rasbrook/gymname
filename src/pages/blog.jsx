...
import expend from '../assets/expend.jpg'
...
function Blog(){
    return(<div>
        ...
        <Blogcontain sorce={cardio}  head='Cardiovascular Health'  contain='Regular exercise improves heart health by enhancing circulation, reducing blood pressure, and lowering the risk of heart disease. Cardio workouts strengthen the heart muscle and improve its efficiency.' />
        <Blogcontain sorce={mental}  head='Mental Health'  contain='Exercise has powerful effects on mental well-being. It releases endorphins (the “feel-good” hormones), reduces stress, anxiety, and depression, and enhances cognitive function. So, whether it’s a brisk walk, a dance class, or lifting weights, moving your body positively impacts your mind.' />
        ...
        <Blogcontain sorce={expend}  head='Caloric Expenditure'  contain='Exercise burns calories, which is crucial for weight management. Whether you’re trying to lose weight or maintain your current weight, consistent physical activity helps create a calorie deficit (if needed) or balance.' />
        <Blogcontain sorce={life}  head='Sustainable Lifestyle: '  contain='Regular exercise contributes to an active lifestyle. When you find activities you enjoy, you’re more likely to stick with them long-term. Consistency matters for achieving and maintaining your weight goals.' />
        </div>
